...
var _testimonials = __webpack_require__(48);

var _testimonials2 = _interopRequireDefault(_testimonials);

var _gmap = __webpack_require__(52);
...
var _gallery = __webpack_require__(62);
...
Vue.component('slider-component', _slider2.default);
Vue.component('testimonials-component', _testimonials2.default);
Vue.component('gmap-component', _gmap2.default);
Vue.component('contact-component', _contact2.default);
Vue.component('gallery-component', _gallery2.default);
Vue.component('subscribe-component', _subscribe2.default);
...
/* scopeId */
var __vue_scopeId__ = "data-v-721d5442"
/* moduleIdentifier (server only) */
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/images?type=s').then(function (response) {
      _this.slides = response.data;
      _this.size = _this.slides.length - 1;
      _this.startRotation();
      _this.loaded = true;
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-633866b2"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/testimonials').then(function (response) {
      ...
      _this.size = _this.testimonials.length - 1;
      _this.loaded = true;
    }).catch(function (error) {
      console.log(error);
    });
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-31ab47da"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-31ab47da", Component.options)
  } else {
    hotAPI.reload("data-v-31ab47da", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    _googleMaps2.default.KEY = this.KEY;

    _googleMaps2.default.load(function () {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-31ab47da", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-1fbba092"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1fbba092", Component.options)
  } else {
    hotAPI.reload("data-v-1fbba092", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
      ...
      _c("input", {
        directives: [
          ...
          },
          {
            name: "validate",
            rawName: "v-validate",
            value: _vm.emailRules,
            expression: "emailRules"
          }
        ],
      ...
      _c("input", {
        directives: [
          ...
          },
          {
            name: "validate",
            rawName: "v-validate",
            value: _vm.subjectRules,
            expression: "subjectRules"
          }
        ],
        class: { error: _vm.errors.has("subject") },
      ...
      _c("textarea", {
        directives: [
          ...
          },
          {
            name: "validate",
            rawName: "v-validate",
            value: _vm.messageRules,
            expression: "messageRules"
          }
        ],
        class: { error: _vm.errors.has("message") },
        attrs: { name: "message" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1fbba092", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-c59fea78"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c59fea78", Component.options)
  } else {
    hotAPI.reload("data-v-c59fea78", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var _vueGallery = __webpack_require__(16);
...
var _vuePopperjs = __webpack_require__(19);

var _vuePopperjs2 = _interopRequireDefault(_vuePopperjs);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-00a22d18", Component.options)
  } else {
    hotAPI.reload("data-v-00a22d18", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-00a22d18", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      this.loading == true ? _c("div", { staticClass: "loading" }) : _vm._e(),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "images" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c59fea78", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-d19eb388"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d19eb388", Component.options)
  } else {
    hotAPI.reload("data-v-d19eb388", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-d19eb388", module.exports)
  }
}
