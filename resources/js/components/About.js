    ...
    <Layout.Content className="app-about">
      ...
      <Row className="app-about-row">
        ...
        <Col sm={8} className="app-about-figure">
          <img className="app-about-image" src="/badam.jpeg" alt="rumi almonds" />
        </Col>
      </Row>
      <Row className="app-about-row">
        <Col sm={16} className="app-about-paragraph">
        ...
        <Col sm={8} className="app-about-figure">
          <img className="app-about-image" src="/kishmish.jpeg" alt="rumi kishmish" />
        </Col>
      </Row>
      <Row className="app-about-row">
        <Col sm={16} className="app-about-paragraph">
        ...
        <Col sm={8} className="app-about-figure">
          <img className="app-about-image" src="/zafran.jpeg" alt="rumi saffron" />
        </Col>
      </Row>
    </Layout.Content>
  )
